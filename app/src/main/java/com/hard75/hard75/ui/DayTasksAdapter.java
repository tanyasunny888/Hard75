...
public class DayTasksAdapter extends RecyclerView.Adapter<DayTasksAdapter.VH> {
    ...
    public DayTasksAdapter(OnToggle onToggle) { this.onToggle = onToggle; }

    public void submit(List<DayTaskEntity> data) { items.clear(); items.addAll(data); notifyDataSetChanged(); }
    ...
    @Override public void onBindViewHolder(@NonNull VH h, int pos) {
        ...
        h.cb.setOnCheckedChangeListener((buttonView, isChecked) -> onToggle.onToggle(t, isChecked));
    }
    ...
    static class VH extends RecyclerView.ViewHolder {
        CheckBox cb;
        VH(@NonNull CheckBox itemView) { super(itemView); cb = itemView; }
    }
}
